...
class GeneratorNode(Node):
    """
    GeneratorNode will execute a Node multiple times and fill a queue with the results.
    The __call__ method returns a queue-result. The result is done in another thread.
    """
    def __init__(
        self,
        name: str,
    ...
    def __call__(self, call_method: str = None, *args, **kwargs):
        """
            Read result from queue and returns it
